...
f2 = plot(title = "Average Loss "*str_regression, hh, mean(sgld1_results2, dims = 2)[:], xaxis = :log, label = "sgld1")
...
savefig(fout, "./scripts/"*str_regression*"/prediction/output/output1.png")
